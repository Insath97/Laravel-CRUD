        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="p-2 h3 text-light">{{ __('Create New Processor') }}</div>
                    <div class="p-2">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active text-light" aria-current="page">Create New</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <form action="{{ route('crud.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('cores') is-invalid @enderror" name="cores">
                            @error('cores')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('tdp') is-invalid @enderror " name="tdp">
                            @error('tdp')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
